		...
		<c:forEach items="${list }" var="m">
			<tr>
				...
				<td>
					...
					<c:if test="${m.status == 1 }"><a href="updateStatus.do?status=2&mid=${m.mid }">上架</a></c:if>
				</td>
			</tr>
		</c:forEach>
		<tr>
			<td colspan="15">
				...
				<input type="button" value="上一页" onclick="page('${pageInfo.pageNum == pageInfo.lastPage?pageInfo.lastPage:pageInfo.nextPage}')">
				<input type="button" value="首页" onclick="page('${pageInfo.lastPage}')">
			</td>
		</tr>
	</table>
</body>
